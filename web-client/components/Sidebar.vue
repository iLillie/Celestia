...
let sidebar = computed(() => {
  return {
    navigationLists: [
    {
      ...
      items: [
        {id: 0, href: '/app', icon: 'ri-home-line', text: 'Oversikt'},
        {id: 1, href: '/app/jobber', icon: 'ri-briefcase-3-line', text: 'Jobber'},
        {id: 2, href: '/app/selskaper', icon: 'ri-building-2-line', text: 'Selskaper'},
        {id: 3, href: '/app/kontakter', icon: 'ri-contacts-book-2-line', text: 'Kontakter'},
      ]
    },
    {
      name: "Favoritter",
